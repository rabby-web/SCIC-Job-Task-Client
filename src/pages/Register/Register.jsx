      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full bg-slate-50 border border-slate-300 rounded-lg  md:mt-0 sm:max-w-md xl:p-0  ">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <h1 className="text-xl font-bold leading-tight tracking-tight text-blue-01 md:text-2xl">
            ...
            <form onSubmit={handleRegister} className="space-y-4 md:space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-01 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center"
              >
                Register
              </button>
              <p className="text-base text-center font-light text-gray-900">
                ...
                <Link to="/login">
                  <button
                    href="#"
                    className="font-semibold text-blue-01 hover:underline "
                  >
                    Login
                  </button>
                </Link>
